...
function handleSubmit(e) {
    ...
    axios.post('http://localhost:4003/cities', body)
        .then(() => {
...
function deleteCard(id) {
    axios.delete(`http://localhost:4003/cities/${id}`)
        .then(() => getCities())
...
function getCities() {
    ...
    axios.get('http://localhost:4003/cities/')
        .then(res => {
...
function getCountries() {
    axios.get('http://localhost:4003/countries')
        .then(res => {
